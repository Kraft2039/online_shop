		...
		<form action="{{ route('products.update', $product->id) }}" method="post">
            ...
            @method('patch')
		  	<div class="form-group">
			    ...
			    <input type="text" name="name_prod" class="form-control" id="name_prod" placeholder="Name_prod" value="{{ $product->name_prod }}">
                ...
                <select class="form-control" id="l2_category_id" name="l2_category_id">
                    <option>@if ($product->l2_category_id != null) {{ $l2_categories[$product->l2_category_id-1]->name_cat }} @else  @endif</option>
                    <option></option>
                ...
                <select class="form-control" id="l3_category_id" name="l3_category_id">
                    <option>@if ($product->l3_category_id != null) {{ $l3_categories[$product->l3_category_id-1]->name_cat }} @else  @endif</option>
                    <option></option>
